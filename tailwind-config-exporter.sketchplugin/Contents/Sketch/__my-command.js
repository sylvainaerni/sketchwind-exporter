...
var wrapDigitKey = function wrapDigitKey(key) {
  ...
  return key.replace(/-./g, function (x) {
...
var addColor = function addColor(item, colorValue) {
  ...
  if (!(name in _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].colors)) _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].colors[name] = {}; // create color variation if it exists

  if (variation) {
    _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].colors[name][variation] = value;
  } else {
    _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].colors[name] = value;
  }
};
var addSpacing = function addSpacing(item, spacingValue) {
  ...
  if (!(name in _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].spacing)) _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].spacing[name] = {};
  _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].spacing[name] = value;
};
