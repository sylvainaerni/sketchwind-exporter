...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/27c8b9632be3180bc25958fc681408f3.html";
...
/*!***************************!*\
  !*** ./src/extractors.js ***!
  \***************************/
/*! exports provided: extractNaming, extractFontNaming, extractFontProperties, extractStyles, extractColorValue, extractBorderRadius, extractShadows, extractBorderWidth, extractDimensions, extractArtboardWidth, extractOpacityValue */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractNaming", function() { return extractNaming; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractFontNaming", function() { return extractFontNaming; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractFontProperties", function() { return extractFontProperties; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractStyles", function() { return extractStyles; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractColorValue", function() { return extractColorValue; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractBorderRadius", function() { return extractBorderRadius; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractShadows", function() { return extractShadows; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractBorderWidth", function() { return extractBorderWidth; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractDimensions", function() { return extractDimensions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractArtboardWidth", function() { return extractArtboardWidth; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "extractOpacityValue", function() { return extractOpacityValue; });
...
var extractNaming = function extractNaming(element) {
  var _element$name$replace = element.name.replace(/\/\s*$/, '').split('/'),
      _element$name$replace2 = _slicedToArray(_element$name$replace, 3),
      category = _element$name$replace2[0],
      item = _element$name$replace2[1],
      variation = _element$name$replace2[2];
...
var extractFontNaming = function extractFontNaming(element) {
  var _element$name$replace3 = element.name.replace(/\/\s*$/, '').split('/'),
      _element$name$replace4 = _slicedToArray(_element$name$replace3, 4),
      sizing = _element$name$replace4[0],
      hierarchy = _element$name$replace4[1],
      weight = _element$name$replace4[2],
      alignment = _element$name$replace4[3];
...
var extractFontProperties = function extractFontProperties(SharedStyle) {
...
var extractStyles = function extractStyles(layer) {
  //unperformant af, need to find a way: let styles = clone(layer.style)
  var styles = Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(layer, 'styles') | null;
  var color = Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(styles, '.fills[0].color') | null;
  var shadows = styles.shadows; // assumption : we do not support multifill atm

  return layer.styles || null;
};
var extractColorValue = function extractColorValue(layer) {
  // assumption : we do not support multifill atm
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(layer, 'style.fills[0].color') || null;
};
var extractBorderRadius = function extractBorderRadius(symbol) {
  var points = Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(symbol, 'layers[0].points');
  if (!points || !points.length) return;
  var borderRadius = points.map(function (point) {
...
var extractShadows = function extractShadows(layer) {
  // sketch shadows are very abstract and fragmented
  var sketchShadows = Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(layer, 'style.shadows');
  var sketchInnerShadows = Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(layer, 'style.innerShadows'); // shadows can be layered

  var shadows = sketchShadows.map(function (_) {
    /* offset-x | offset-y | blur-radius | spread | color */
    return "".concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["convertIntToPX"])(_.x), " ").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["convertIntToPX"])(_.y), " ").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["convertIntToPX"])(_.blur), " ").concat(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["convertIntToPX"])(_.spread), " ").concat(_.color);
  }).join(', ');
  var innerShadows = sketchInnerShadows.map(function (_) {
...
var extractBorderWidth = function extractBorderWidth(layer) {
  // assumption : we do not support multifill atm
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(layer, 'style.borders[0].thickness') || null;
};
var extractDimensions = function extractDimensions(element) {
  // assumption : we do not support multifill atm
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(element, 'frame') || null;
};
var extractArtboardWidth = function extractArtboardWidth(layer) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(layer, 'frame.width') || null;
};
var extractOpacityValue = function extractOpacityValue(layer) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_0__["get"])(layer, 'style.opacity') || null;
};
...
/*!************************!*\
  !*** ./src/helpers.js ***!
  \************************/
/*! exports provided: convertPxToREM, convertRemToPX, convertIntToPX, convertColor, convertToRgba, wrapDigitKey, roundToTwo */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertPxToREM", function() { return convertPxToREM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertRemToPX", function() { return convertRemToPX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertIntToPX", function() { return convertIntToPX; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertColor", function() { return convertColor; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "convertToRgba", function() { return convertToRgba; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "wrapDigitKey", function() { return wrapDigitKey; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "roundToTwo", function() { return roundToTwo; });
var convertPxToREM = function convertPxToREM(value) {
  return roundToTwo(value / 16) + "rem";
};
var convertRemToPX = function convertRemToPX(value) {
  return roundToTwo(value * 16) + "rem";
};
var convertIntToPX = function convertIntToPX(value) {
  return value + "px";
};
var convertColor = function convertColor(value) {
...
var convertToRgba = function convertToRgba(color) {
  var value = color.substring(1, 9);
  var red = parseInt(value.substring(0, 2), 16);
  var green = parseInt(value.substring(2, 4), 16);
  var blue = parseInt(value.substring(4, 6), 16);
  var alpha = Math.round(parseInt(value.substring(6, 8), 16) / 255 * 100) / 100;
  return "rgba(".concat(red, ", ").concat(green, ", ").concat(blue, ", ").concat(alpha, ")");
};
var wrapDigitKey = function wrapDigitKey(key) {
  if (typeof key !== 'string') return key; // wrap object keys with simple quotes
...
/* harmony import */ var _extractors__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./extractors */ "./src/extractors.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers */ "./src/helpers.js");
/* harmony import */ var _themeHandlers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./themeHandlers */ "./src/themeHandlers.js");
...
textStyles.forEach(function (style) {
  if (style.styleType === 'Style') {
    var fontData = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractFontNaming"])(style);
    var fontStyles = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractFontProperties"])(style);
    Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addFontSize"])(fontData.sizing, fontStyles);
    Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addFontFamily"])(fontData.hierarchy, fontStyles.fontFamily);
  }
});
symbols.forEach(function (symbol) {
  var item = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractNaming"])(symbol);

  if (item.variation && item.variation.includes("radius")) {
    var borderRadius = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractBorderRadius"])(symbol);
    Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addBorderRadius"])(item, borderRadius);
  }

  if (item.category === 'spacing') {
    var spacer = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractDimensions"])(symbol);

    if (spacer.height) {
      // the size 1 is in tailwind 1 pixel, not 1/16 rem
      if (spacer.height > 1) {
        Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addSpacing"])(item, Object(_helpers__WEBPACK_IMPORTED_MODULE_5__["convertPxToREM"])(spacer.height));
      } else {
        Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addSpacing"])(item, Object(_helpers__WEBPACK_IMPORTED_MODULE_5__["convertIntToPX"])(spacer.height));
      }
    }
  }
});
layerStyles.forEach(function (layer) {
  var item = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractNaming"])(layer);

  if (item.category === 'strokeWidth') {
    var borderWidth = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractBorderWidth"])(layer);
    if (borderWidth) Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addStroke"])(borderWidth, Object(_helpers__WEBPACK_IMPORTED_MODULE_5__["convertIntToPX"])(borderWidth));
  }

  if (item.category === 'boxShadow') {
    var shadowDefinitions = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractShadows"])(layer);
    Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addShadow"])(item.item, shadowDefinitions.shadows);
  }

  if (item.category === 'borderWidth') {
    var _borderWidth = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractBorderWidth"])(layer);

    if (_borderWidth) Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addBorderWidth"])(_borderWidth, Object(_helpers__WEBPACK_IMPORTED_MODULE_5__["convertIntToPX"])(_borderWidth));
  }

  if (item.category === 'color') {
    var color = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractColorValue"])(layer);
    if (color) Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addColor"])(item, Object(_helpers__WEBPACK_IMPORTED_MODULE_5__["convertColor"])(color));
  }

  if (item.category === 'opacity') {
    var opacity = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractOpacityValue"])(layer);
    if (opacity) Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addOpacity"])(item, Object(_helpers__WEBPACK_IMPORTED_MODULE_5__["roundToTwo"])(opacity));
  }
});
  ...
  page.layers.forEach(function (layer) {
    if (layer.type === 'Artboard') {
      ...
      if (item.category === 'screen') {
        var artboardWidth = Object(_extractors__WEBPACK_IMPORTED_MODULE_4__["extractArtboardWidth"])(layer);
        if (artboardWidth) Object(_themeHandlers__WEBPACK_IMPORTED_MODULE_6__["addScreen"])(item, Object(_helpers__WEBPACK_IMPORTED_MODULE_5__["convertIntToPX"])(artboardWidth));
      }
    }
  });
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var configExport = 'theme: ' + tailwindConfig; // print a message when the page loads

  webContents.on('did-finish-load', function () {
    sketch_ui__WEBPACK_IMPORTED_MODULE_2___default.a.message("Let's export your stuff!");
    webContents.executeJavaScript("populateTextArea(".concat(JSON.stringify(configExport), ")")).catch(console.error);
...
/***/ "./src/themeHandlers.js":
/*!******************************!*\
  !*** ./src/themeHandlers.js ***!
  \******************************/
/*! exports provided: addColor, addSpacing, addBorderRadius, addShadow, addBorderWidth, addStroke, addFontSize, addFontFamily, addScreen, addOpacity */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addBorderRadius", function() { return addBorderRadius; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addShadow", function() { return addShadow; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addBorderWidth", function() { return addBorderWidth; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addStroke", function() { return addStroke; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addFontSize", function() { return addFontSize; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addFontFamily", function() { return addFontFamily; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addScreen", function() { return addScreen; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addOpacity", function() { return addOpacity; });
/* harmony import */ var _theme__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./theme */ "./src/theme.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ "./src/helpers.js");


var addColor = function addColor(item, colorValue) {
  var name = item.item;
  var variation = item.variation;
  var value = colorValue;
  if (name.startsWith('_')) name = name.slice(1); // create color object if color doesn't exist

  if (!(name in _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].colors)) _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].colors[Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["wrapDigitKey"])(name)] = {}; // create color variation if it exists

  if (variation) {
    _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].colors[Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["wrapDigitKey"])(name)][variation] = value;
  } else {
    _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].colors[Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["wrapDigitKey"])(name)] = value;
  }
};
var addSpacing = function addSpacing(item, spacingValue) {
  if (!item.item) return;
  var name = item.item;
  var value = spacingValue; // create spacing object if it doesn't exist

  if (!(name in _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].spacing)) _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].spacing[Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["wrapDigitKey"])(name)] = {};
  _theme__WEBPACK_IMPORTED_MODULE_0__["theme"].spacing[Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["wrapDigitKey"])(name)] = value;
};
